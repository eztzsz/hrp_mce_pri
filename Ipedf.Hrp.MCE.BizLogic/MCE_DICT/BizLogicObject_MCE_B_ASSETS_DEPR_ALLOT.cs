...
namespace Ipedf.Web.BizLogic
{
	...
	public partial class BizLogicObject_MCE_B_ASSETS_DEPR_ALLOT: BizLogicBase<EntityObject_MCE_B_ASSETS_DEPR_ALLOT>,ServiceContract_MCE_B_ASSETS_DEPR_ALLOT
	{	
		#region Proxy 
		public BizLogicObject_MCE_B_ASSETS_DEPR_ALLOT() { }
        private static ServiceContract_MCE_B_ASSETS_DEPR_ALLOT singleton;
        public static ServiceContract_MCE_B_ASSETS_DEPR_ALLOT Proxy
        {
            get 
            {
                if (singleton == null) singleton = new BizLogicObject_MCE_B_ASSETS_DEPR_ALLOT();
                    return singleton;
            }
        }
        #endregion	
		#region Method Blok
		public BizLogicMsg Save(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
		{
			if (LocalMode)
			{
		...
		public BizLogicMsg Update(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
		...
		public BizLogicMsg Delete(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
				using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
				{
					...
					{ 
						try
						{
							int amount = HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Delete(obj, transaction);
					//平台自动生成代码
							transaction.Commit();
						}
						catch (Exception expt)
		...
		public DisplayObject_MCE_B_ASSETS_DEPR_ALLOT Get(DisplayObject_MCE_B_ASSETS_DEPR_ALLOT obj)
		{
			if (LocalMode)
			{
		...
		public DisplayObject_MCE_B_ASSETS_DEPR_ALLOT[] Query(CauseObject_MCE_B_ASSETS_DEPR_ALLOT cause)
		{			
			if (LocalMode)
			{
			...
			//平台自动生成代码
			return HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Query(cause);
			}
			else
			{
				using (ServiceManager<ServiceContract_MCE_B_ASSETS_DEPR_ALLOT> smgr = new ServiceManager<ServiceContract_MCE_B_ASSETS_DEPR_ALLOT>(ServiceUri))
		...
		public BizLogicMsg BatchSave(EntityObject_MCE_B_ASSETS_DEPR_ALLOT[] objs)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
			...
			//平台自动生成代码
					foreach (EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj in objs)
					{
						amount += HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Save(obj, transaction);
					}
							transaction.Commit();
						}
						catch (Exception expt)
        ...
        public BizLogicMsg BatchDelete(EntityObject_MCE_B_ASSETS_DEPR_ALLOT[] objs)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
			...
			//平台自动生成代码
					foreach (EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj in objs)
					{
						amount += HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Delete(obj, transaction);
					}
							transaction.Commit();
						}
						catch (Exception expt)
        ...
        public BizLogicMsg Cancel(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Audit(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Archive(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Submit(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg UndoSubmit(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public int DeleteByTrans(EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj, IDbTransaction transaction)
        {
            if (LocalMode)
            {
				return HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Delete(obj, transaction);
					//平台自动生成代码
            }
            else
            {
        ...
        public EntityObject_MCE_B_ASSETS_DEPR_ALLOT Load(string id , out EntityObject_COM_DEPART dept_id, out EntityObject_MCE_B_ASSETS assets_id, out EntityObject_MCE_D_DEPR_TYPE depr_id)
		{
			if (LocalMode)
			{
			...
			depr_id = new EntityObject_MCE_D_DEPR_TYPE() ; 
				...
				using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
				{
					using (IDbTransaction transaction = connection.BeginTransaction())
					{
						try
						{
							obj = Load(transaction,id , out  dept_id, out  assets_id, out  depr_id);                
							transaction.Commit();
						}
						catch (Exception expt)
						{
			...
			else
			{
				using (ServiceManager<ServiceContract_MCE_B_ASSETS_DEPR_ALLOT> smgr = new ServiceManager<ServiceContract_MCE_B_ASSETS_DEPR_ALLOT>(ServiceUri))
                {
                    return smgr.Service.Load(id , out dept_id, out assets_id, out depr_id);
                }
			}
		}
		...
		public BizLogicMsg CommitUpdate(EntityObject_MCE_B_ASSETS_DEPR_ALLOT[] saveEntities, EntityObject_MCE_B_ASSETS_DEPR_ALLOT[] updateEntities, EntityObject_MCE_B_ASSETS_DEPR_ALLOT[] deleteEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
                {
                    using (IDbTransaction transaction = connection.BeginTransaction())
                    {
                        ...
                        {
                            //平台自动生成代码
                            foreach (EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj in saveEntities)
                            {
                                SystemLogic.Proxy.AuditAdd(obj);
                                HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Save(obj, transaction);
                            }
                            foreach (EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj in updateEntities)
                            {
                                SystemLogic.Proxy.AuditEdit(obj);
                                HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Update(obj, transaction);
                            }
                            foreach (EntityObject_MCE_B_ASSETS_DEPR_ALLOT obj in deleteEntities)
                            {
		...
		#if NESTING
		public BizLogicMsg CommitSave(EntityObject_MCE_B_ASSETS_DEPR_ALLOT saveBaseEntity, EntityObject_[] saveDetailEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
                {
                    using (IDbTransaction transaction = connection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            HelperObject_MCE_B_ASSETS_DEPR_ALLOT.Save(saveBaseEntity, transaction);
