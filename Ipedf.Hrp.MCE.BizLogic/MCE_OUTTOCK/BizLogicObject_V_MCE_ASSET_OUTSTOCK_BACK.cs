...
namespace Ipedf.Web.BizLogic
{
	...
	public partial class BizLogicObject_V_MCE_ASSET_OUTSTOCK_BACK: BizLogicBase<EntityObject_V_MCE_ASSET_OUTSTOCK_BACK>,ServiceContract_V_MCE_ASSET_OUTSTOCK_BACK
	{	
		#region Proxy 
		public BizLogicObject_V_MCE_ASSET_OUTSTOCK_BACK() { }
        private static ServiceContract_V_MCE_ASSET_OUTSTOCK_BACK singleton;
        public static ServiceContract_V_MCE_ASSET_OUTSTOCK_BACK Proxy
        {
            get 
            {
                if (singleton == null) singleton = new BizLogicObject_V_MCE_ASSET_OUTSTOCK_BACK();
                    return singleton;
            }
        }
        #endregion	
		#region Method Blok
		public BizLogicMsg Save(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
		{
			if (LocalMode)
			{
		...
		public BizLogicMsg Update(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
		...
		public BizLogicMsg Delete(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
				using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
				{
					...
					{ 
						try
						{
							int amount = HelperObject_V_MCE_ASSET_OUTSTOCK_BACK.Delete(obj, transaction);
					//平台自动生成代码
							transaction.Commit();
						}
						catch (Exception expt)
		...
		public DisplayObject_V_MCE_ASSET_OUTSTOCK_BACK Get(DisplayObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
		{
			if (LocalMode)
			{
		...
		public DisplayObject_V_MCE_ASSET_OUTSTOCK_BACK[] Query(CauseObject_V_MCE_ASSET_OUTSTOCK_BACK cause)
		{			
			if (LocalMode)
			{
			...
			//平台自动生成代码
			return HelperObject_V_MCE_ASSET_OUTSTOCK_BACK.Query(cause);
			}
			else
			{
				using (ServiceManager<ServiceContract_V_MCE_ASSET_OUTSTOCK_BACK> smgr = new ServiceManager<ServiceContract_V_MCE_ASSET_OUTSTOCK_BACK>(ServiceUri))
		...
		public BizLogicMsg BatchSave(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK[] objs)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
			...
			//平台自动生成代码
					foreach (EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj in objs)
					{
						amount += HelperObject_V_MCE_ASSET_OUTSTOCK_BACK.Save(obj, transaction);
					}
							transaction.Commit();
						}
						catch (Exception expt)
        ...
        public BizLogicMsg Cancel(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Audit(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Archive(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Submit(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg UndoSubmit(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public int DeleteByTrans(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj, IDbTransaction transaction)
        {
            if (LocalMode)
            {
				return HelperObject_V_MCE_ASSET_OUTSTOCK_BACK.Delete(obj, transaction);
					//平台自动生成代码
            }
            else
            {
        ...
        public EntityObject_V_MCE_ASSET_OUTSTOCK_BACK Load(string id )
		{
			if (LocalMode)
			{
				EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj = new EntityObject_V_MCE_ASSET_OUTSTOCK_BACK();
		...
		public EntityObject_V_MCE_ASSET_OUTSTOCK_BACK Load(IDbTransaction transaction,string id )
		{
			if (LocalMode)
			{
				EntityObject_V_MCE_ASSET_OUTSTOCK_BACK obj = new EntityObject_V_MCE_ASSET_OUTSTOCK_BACK();
		...
		#if NESTING
		public BizLogicMsg CommitSave(EntityObject_V_MCE_ASSET_OUTSTOCK_BACK saveBaseEntity, EntityObject_[] saveDetailEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
                {
                    using (IDbTransaction transaction = connection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            HelperObject_V_MCE_ASSET_OUTSTOCK_BACK.Save(saveBaseEntity, transaction);
							
                            //平台自动生成代码
                            foreach (EntityObject_ obj in saveDetailEntities)
                            {
                                obj. = saveBaseEntity.ASSETS_CODE;
                                SystemLogic.Proxy.AuditAdd(obj);
