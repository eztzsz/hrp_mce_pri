...
namespace Ipedf.Web.BizLogic
{
	...
	public partial class BizLogicObject_MCE_B_ASSETS_ROLLFILE: BizLogicBase<EntityObject_MCE_B_ASSETS_ROLLFILE>,ServiceContract_MCE_B_ASSETS_ROLLFILE
	{	
		#region Proxy 
		public BizLogicObject_MCE_B_ASSETS_ROLLFILE() { }
        private static ServiceContract_MCE_B_ASSETS_ROLLFILE singleton;
        public static ServiceContract_MCE_B_ASSETS_ROLLFILE Proxy
        {
            get 
            {
                if (singleton == null) singleton = new BizLogicObject_MCE_B_ASSETS_ROLLFILE();
                    return singleton;
            }
        }
        #endregion	
		#region Method Blok
		public BizLogicMsg Save(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
		{
			if (LocalMode)
			{
		...
		public BizLogicMsg Update(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
		...
		public BizLogicMsg Delete(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
				using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
				{
					...
					{ 
						try
						{
							int amount = HelperObject_MCE_B_ASSETS_ROLLFILE.Delete(obj, transaction);
					//平台自动生成代码
							transaction.Commit();
						}
						catch (Exception expt)
		...
		public DisplayObject_MCE_B_ASSETS_ROLLFILE Get(DisplayObject_MCE_B_ASSETS_ROLLFILE obj)
		{
			if (LocalMode)
			{
		...
		public DisplayObject_MCE_B_ASSETS_ROLLFILE[] Query(CauseObject_MCE_B_ASSETS_ROLLFILE cause)
		{			
			if (LocalMode)
			{
			...
			//平台自动生成代码
			return HelperObject_MCE_B_ASSETS_ROLLFILE.Query(cause);
			}
			else
			{
				using (ServiceManager<ServiceContract_MCE_B_ASSETS_ROLLFILE> smgr = new ServiceManager<ServiceContract_MCE_B_ASSETS_ROLLFILE>(ServiceUri))
		...
		public BizLogicMsg BatchSave(EntityObject_MCE_B_ASSETS_ROLLFILE[] objs)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
			...
			//平台自动生成代码
					foreach (EntityObject_MCE_B_ASSETS_ROLLFILE obj in objs)
					{
						amount += HelperObject_MCE_B_ASSETS_ROLLFILE.Save(obj, transaction);
					}
							transaction.Commit();
						}
						catch (Exception expt)
        ...
        public BizLogicMsg BatchDelete(EntityObject_MCE_B_ASSETS_ROLLFILE[] objs)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
			...
			//平台自动生成代码
					foreach (EntityObject_MCE_B_ASSETS_ROLLFILE obj in objs)
					{
						amount += HelperObject_MCE_B_ASSETS_ROLLFILE.Delete(obj, transaction);
					}
							transaction.Commit();
						}
						catch (Exception expt)
        ...
        public BizLogicMsg Cancel(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Audit(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Archive(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Submit(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg UndoSubmit(EntityObject_MCE_B_ASSETS_ROLLFILE obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public int DeleteByTrans(EntityObject_MCE_B_ASSETS_ROLLFILE obj, IDbTransaction transaction)
        {
            if (LocalMode)
            {
				return HelperObject_MCE_B_ASSETS_ROLLFILE.Delete(obj, transaction);
					//平台自动生成代码
            }
            else
            {
        ...
        public EntityObject_MCE_B_ASSETS_ROLLFILE Load(string id , out EntityObject_MCE_B_ASSETS_ROLL base_id)
		{
			if (LocalMode)
			{
		...
		public BizLogicMsg CommitUpdate(EntityObject_MCE_B_ASSETS_ROLLFILE[] saveEntities, EntityObject_MCE_B_ASSETS_ROLLFILE[] updateEntities, EntityObject_MCE_B_ASSETS_ROLLFILE[] deleteEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
                {
                    using (IDbTransaction transaction = connection.BeginTransaction())
                    {
                        ...
                        {
                            //平台自动生成代码
                            foreach (EntityObject_MCE_B_ASSETS_ROLLFILE obj in saveEntities)
                            {
                                SystemLogic.Proxy.AuditAdd(obj);
                                HelperObject_MCE_B_ASSETS_ROLLFILE.Save(obj, transaction);
                            }
                            foreach (EntityObject_MCE_B_ASSETS_ROLLFILE obj in updateEntities)
                            {
                                SystemLogic.Proxy.AuditEdit(obj);
                                HelperObject_MCE_B_ASSETS_ROLLFILE.Update(obj, transaction);
                            }
                            foreach (EntityObject_MCE_B_ASSETS_ROLLFILE obj in deleteEntities)
                            {
		...
		#if NESTING
		public BizLogicMsg CommitSave(EntityObject_MCE_B_ASSETS_ROLLFILE saveBaseEntity, EntityObject_[] saveDetailEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
                {
                    using (IDbTransaction transaction = connection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            HelperObject_MCE_B_ASSETS_ROLLFILE.Save(saveBaseEntity, transaction);
