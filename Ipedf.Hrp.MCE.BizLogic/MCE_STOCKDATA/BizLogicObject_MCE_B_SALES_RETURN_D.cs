...
namespace Ipedf.Web.BizLogic
{
	...
	public partial class BizLogicObject_MCE_B_SALES_RETURN_D: BizLogicBase<EntityObject_MCE_B_SALES_RETURN_D>,ServiceContract_MCE_B_SALES_RETURN_D
	{	
		#region Proxy 
		public BizLogicObject_MCE_B_SALES_RETURN_D() { }
        private static ServiceContract_MCE_B_SALES_RETURN_D singleton;
        public static ServiceContract_MCE_B_SALES_RETURN_D Proxy
        {
            get 
            {
                if (singleton == null) singleton = new BizLogicObject_MCE_B_SALES_RETURN_D();
                    return singleton;
            }
        }
        #endregion	
		#region Method Blok
		public BizLogicMsg Save(EntityObject_MCE_B_SALES_RETURN_D obj)
		{
			if (LocalMode)
			{
		...
		public BizLogicMsg Update(EntityObject_MCE_B_SALES_RETURN_D obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
		...
		public BizLogicMsg Delete(EntityObject_MCE_B_SALES_RETURN_D obj)
		{
			if (LocalMode)
			{
				BizLogicMsg msg = new BizLogicMsg();
				using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
				{
					...
					{ 
						try
						{
							int amount = HelperObject_MCE_B_SALES_RETURN_D.Delete(obj, transaction);
					//平台自动生成代码
							transaction.Commit();
						}
						catch (Exception expt)
		...
		public DisplayObject_MCE_B_SALES_RETURN_D Get(DisplayObject_MCE_B_SALES_RETURN_D obj)
		{
			if (LocalMode)
			{
		...
		public DisplayObject_MCE_B_SALES_RETURN_D[] Query(CauseObject_MCE_B_SALES_RETURN_D cause)
		{			
			if (LocalMode)
			{
			...
			//平台自动生成代码
			return HelperObject_MCE_B_SALES_RETURN_D.Query(cause);
			}
			else
			{
				using (ServiceManager<ServiceContract_MCE_B_SALES_RETURN_D> smgr = new ServiceManager<ServiceContract_MCE_B_SALES_RETURN_D>(ServiceUri))
		...
		public BizLogicMsg BatchSave(EntityObject_MCE_B_SALES_RETURN_D[] objs)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
			...
			//平台自动生成代码
					foreach (EntityObject_MCE_B_SALES_RETURN_D obj in objs)
					{
						amount += HelperObject_MCE_B_SALES_RETURN_D.Save(obj, transaction);
					}
							transaction.Commit();
						}
						catch (Exception expt)
        ...
        public BizLogicMsg BatchDelete(EntityObject_MCE_B_SALES_RETURN_D[] objs)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
			...
			//平台自动生成代码
					foreach (EntityObject_MCE_B_SALES_RETURN_D obj in objs)
					{
						amount += HelperObject_MCE_B_SALES_RETURN_D.Delete(obj, transaction);
					}
							transaction.Commit();
						}
						catch (Exception expt)
        ...
        public BizLogicMsg Cancel(EntityObject_MCE_B_SALES_RETURN_D obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Audit(EntityObject_MCE_B_SALES_RETURN_D obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Archive(EntityObject_MCE_B_SALES_RETURN_D obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg Submit(EntityObject_MCE_B_SALES_RETURN_D obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public BizLogicMsg UndoSubmit(EntityObject_MCE_B_SALES_RETURN_D obj)
        {
            if (LocalMode)
            {
				BizLogicMsg msg = new BizLogicMsg();
        ...
        public int DeleteByTrans(EntityObject_MCE_B_SALES_RETURN_D obj, IDbTransaction transaction)
        {
            if (LocalMode)
            {
				return HelperObject_MCE_B_SALES_RETURN_D.Delete(obj, transaction);
					//平台自动生成代码
            }
            else
            {
		...
		public BizLogicMsg CommitUpdate(EntityObject_MCE_B_SALES_RETURN_D[] saveEntities, EntityObject_MCE_B_SALES_RETURN_D[] updateEntities, EntityObject_MCE_B_SALES_RETURN_D[] deleteEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
                {
                    using (IDbTransaction transaction = connection.BeginTransaction())
                    {
                        ...
                        {
                            //平台自动生成代码
                            foreach (EntityObject_MCE_B_SALES_RETURN_D obj in saveEntities)
                            {
                                SystemLogic.Proxy.AuditAdd(obj);
                                HelperObject_MCE_B_SALES_RETURN_D.Save(obj, transaction);
                            }
                            foreach (EntityObject_MCE_B_SALES_RETURN_D obj in updateEntities)
                            {
                                SystemLogic.Proxy.AuditEdit(obj);
                                HelperObject_MCE_B_SALES_RETURN_D.Update(obj, transaction);
                            }
                            foreach (EntityObject_MCE_B_SALES_RETURN_D obj in deleteEntities)
                            {
                                HelperObject_MCE_B_SALES_RETURN_D.Delete(obj, transaction);
                            }
                            transaction.Commit();
                        }
                        catch (Exception expt)
		...
		#if NESTING
		public BizLogicMsg CommitSave(EntityObject_MCE_B_SALES_RETURN_D saveBaseEntity, EntityObject_[] saveDetailEntities)
        {
            if (LocalMode)
            {
                BizLogicMsg msg = new BizLogicMsg();
                using (IDbConnection connection = IDALProvider.IDAL.PopConnection())
                {
                    using (IDbTransaction transaction = connection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            HelperObject_MCE_B_SALES_RETURN_D.Save(saveBaseEntity, transaction);
