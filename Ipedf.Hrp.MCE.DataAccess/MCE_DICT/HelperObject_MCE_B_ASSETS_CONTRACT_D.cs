...
namespace Ipedf.Web.DataAccess
{
	...
	public partial class HelperObject_MCE_B_ASSETS_CONTRACT_D
	{		
		#region Method Blok
		public static int Save(EntityObject_MCE_B_ASSETS_CONTRACT_D obj,IDbTransaction trans)
		{
			
			//平台自动生成代码
			obj.ID= Guid.NewGuid().ToString();
			string sSql = "insert into MCE_B_ASSETS_CONTRACT_D( ASSET_ID, BASE_ID, ID) values ( :ASSET_ID, :BASE_ID, :ID)";
		...
		public static int Update(EntityObject_MCE_B_ASSETS_CONTRACT_D obj,IDbTransaction trans)
		{
		...
		public static int Delete(EntityObject_MCE_B_ASSETS_CONTRACT_D obj,IDbTransaction trans)
		{
			
			//平台自动生成代码
			string sSql = "delete from MCE_B_ASSETS_CONTRACT_D where  ID = :ID ";
			#region Parameters Block
		...
		public static EntityObject_MCE_B_ASSETS_CONTRACT_D Get(EntityObject_MCE_B_ASSETS_CONTRACT_D obj)
		{
			
			//平台自动生成代码
			string sSql = "select  ASSET_ID, BASE_ID, ID from MCE_B_ASSETS_CONTRACT_D where  ID = :ID ";
			#region Parameters Block
			OracleParameter[] parameters = new OracleParameter[1];
			parameters[0] = new OracleParameter();
			parameters[0].ParameterName =":ID";
			...
			#endregion 
			#region Push Block
			EntityObject_MCE_B_ASSETS_CONTRACT_D dataObj = null;
			ArrayList objArray = new ArrayList();
			IDbConnection connection = IDALProvider.IDAL.PopConnection();
			IDataReader sqlReader = IDALProvider.IDAL.ExecuteReader(sSql,parameters,connection);
			while (sqlReader.Read())
			{
				dataObj = new EntityObject_MCE_B_ASSETS_CONTRACT_D();
			...
			#endregion 
			EntityObject_MCE_B_ASSETS_CONTRACT_D[] objs = new EntityObject_MCE_B_ASSETS_CONTRACT_D[objArray.Count];
			objArray.CopyTo(0,objs,0,objs.Length);
			return objs.Length == 0 ? null:objs[0];
		}
		public static DisplayObject_MCE_B_ASSETS_CONTRACT_D Get(DisplayObject_MCE_B_ASSETS_CONTRACT_D obj)
		{
		...
		public static EntityObject_MCE_B_ASSETS_CONTRACT_D Get(EntityObject_MCE_B_ASSETS_CONTRACT_D obj,IDbTransaction trans)
		{
		...
		public static DisplayObject_MCE_B_ASSETS_CONTRACT_D[] List()
		{
		...
		public static DisplayObject_MCE_B_ASSETS_CONTRACT_D[] Query(CauseObject_MCE_B_ASSETS_CONTRACT_D cause,IDbTransaction trans)
		{
		...
		public static DisplayObject_MCE_B_ASSETS_CONTRACT_D[] Query(CauseObject_MCE_B_ASSETS_CONTRACT_D cause,PagingParamter paging,OrderByParameter order)
		{
			...
			if (paging != null)
			{
				...
				sqlReader = IDALProvider.IDAL.ExecutePagingReader("MCE_B_ASSETS_CONTRACT_D",paging, order, sSql, parameters, connection);
			}
			else if (order != null)
			{
				sSql += order.ToString();
		...
		public static string PrepareUpdate(EntityObject_MCE_B_ASSETS_CONTRACT_D obj, out OracleParameter[] parameters,bool appendpk)
        {
			...
			{
				strBuf.Add("  MCE_B_ASSETS_CONTRACT_D.ASSET_ID = :U_ASSET_ID");
				param = new OracleParameter();
			...
			{
				strBuf.Add("  MCE_B_ASSETS_CONTRACT_D.BASE_ID = :U_BASE_ID");
				param = new OracleParameter();
