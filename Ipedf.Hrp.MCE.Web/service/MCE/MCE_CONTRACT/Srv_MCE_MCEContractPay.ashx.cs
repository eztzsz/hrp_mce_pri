...
{
    /// <summary>
    /// Srv_MCE_MCEContractPay 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEContractPay : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_CONTRACT.Proxy.Contract_Pay2(idList);
                if (!msg.Succeed)
