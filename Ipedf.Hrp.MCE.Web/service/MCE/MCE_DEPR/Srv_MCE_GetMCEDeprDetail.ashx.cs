...
{
    /// <summary>
    /// Srv_MCE_GetMCEDeprDetail 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEDeprDetail : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                DisplayObject_MCE_B_ASSETS_DEPR[] listHead = BizLogicObject_MCE_B_ASSETS_DEPR.Proxy.Query(p);
                ...
                CauseObject_MCE_B_ASSETS_DEPR_D pd = new CauseObject_MCE_B_ASSETS_DEPR_D();
                pd.BASE_ID = request["id"].ToString();

                DisplayObject_MCE_B_ASSETS_DEPR_D[] listDetail = BizLogicObject_MCE_B_ASSETS_DEPR_D.Proxy.Query(pd, null, orderBy);
