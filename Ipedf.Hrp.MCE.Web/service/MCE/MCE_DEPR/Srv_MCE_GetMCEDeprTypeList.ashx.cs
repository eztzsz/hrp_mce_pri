...
{
    /// <summary>
    /// Srv_MCE_GetMCEDeprTypeList 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEDeprTypeList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                DisplayObject_MCE_D_DEPR_TYPE[] list = BizLogicObject_MCE_D_DEPR_TYPE.Proxy.Query(p, pager, orderBy);
