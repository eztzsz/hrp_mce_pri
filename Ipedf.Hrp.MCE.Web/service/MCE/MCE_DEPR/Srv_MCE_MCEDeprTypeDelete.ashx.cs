...
{
    /// <summary>
    /// Srv_MCE_MCEDeprTypeDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEDeprTypeDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择折旧方式.");
                }


                BizLogicMsg msg = BizLogicObject_MCE_D_DEPR_TYPE.Proxy.Delete_Ext(listID);
                if (!msg.Succeed)
