...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsAffixAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsAffixAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
               ...
               string strID = rsb.ToString();
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_AFFIX.Proxy.Audit_Ext(strID);
                if (!msg.Succeed)
