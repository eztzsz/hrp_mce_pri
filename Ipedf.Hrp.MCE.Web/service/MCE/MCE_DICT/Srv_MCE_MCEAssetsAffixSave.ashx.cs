...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsAffixSave 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsAffixSave : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                JsonMceAssersFix item = JsonConvert.DeserializeObject<JsonMceAssersFix>(rsb.ToString());
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_AFFIX.Proxy.Save_Ext(item);
                if (!msg.Succeed)
