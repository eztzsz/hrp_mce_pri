...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsCapitalAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsCapitalAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片附件.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_CAPITAL_ALLOT.Proxy.Audit_Ext(strID);
                if (!msg.Succeed)
