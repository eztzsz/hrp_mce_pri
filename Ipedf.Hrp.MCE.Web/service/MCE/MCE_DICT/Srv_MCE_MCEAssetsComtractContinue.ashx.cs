...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsComtractContinue 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsComtractContinue : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片合同信息.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_CONTRACT.Proxy.Contract_Continue(strID);
                if (!msg.Succeed)
