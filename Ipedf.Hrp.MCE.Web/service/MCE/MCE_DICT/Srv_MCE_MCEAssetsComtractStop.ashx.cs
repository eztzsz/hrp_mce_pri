...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsComtractStop 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsComtractStop : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_CONTRACT.Proxy.Contract_Stop(strID);
                if (!msg.Succeed)
