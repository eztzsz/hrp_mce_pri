...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsDeprAllocAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsDeprAllocAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片折旧信息.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_DEPR_ALLOT.Proxy.Audit_Ext(strID);
                if (!msg.Succeed)
