...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsIMPORTATIONAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsIMPORTATIONAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片进口信息.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_IMPORTATION.Proxy.Audit_Ext(strID);
                if (!msg.Succeed)
