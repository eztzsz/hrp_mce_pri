...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsInsuranceContinue 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsInsuranceContinue : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片保险信息.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_INSURANCE.Proxy.Insurance_Continue(strID);
                if (!msg.Succeed)
