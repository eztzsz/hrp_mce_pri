...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsInsuranceExpire 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsInsuranceExpire : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_INSURANCE.Proxy.Insurance_Expire(strID);
                if (!msg.Succeed)
