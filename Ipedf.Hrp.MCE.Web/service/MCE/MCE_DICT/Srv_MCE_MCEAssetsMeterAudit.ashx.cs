...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsMeterAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsMeterAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_METER.Proxy.Audit_Ext(strID);
                if (!msg.Succeed)
