...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsMeterContinue 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsMeterContinue : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片计量信息.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_METER.Proxy.Meter_Continue(strID);
                if (!msg.Succeed)
