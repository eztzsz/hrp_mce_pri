...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsMeterDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsMeterDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择计量信息删除.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_METER.Proxy.Delete_Ext(strID);
                if (!msg.Succeed)
