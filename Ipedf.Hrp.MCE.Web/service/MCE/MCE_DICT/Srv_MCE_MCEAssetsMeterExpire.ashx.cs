...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsMeterExpire 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsMeterExpire : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_METER.Proxy.Meter_Expire(strID);
                if (!msg.Succeed)
