...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsWriteOffAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsWriteOffAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片报废信息.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_WRITE_OFF.Proxy.Audit_Ext(strID);
                if (!msg.Succeed)
