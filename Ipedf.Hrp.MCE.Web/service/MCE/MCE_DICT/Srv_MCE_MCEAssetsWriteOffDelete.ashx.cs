...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsWriteOffDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsWriteOffDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择报废信息删除.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_WRITE_OFF.Proxy.Delete_Ext(strID);
                if (!msg.Succeed)
