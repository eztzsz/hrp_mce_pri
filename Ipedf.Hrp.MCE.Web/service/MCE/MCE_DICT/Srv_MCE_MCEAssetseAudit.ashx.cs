...
{
    /// <summary>
    /// Srv_MCE_MCEAssetseAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetseAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS.Proxy.Audit_Ext(listID);
                if (!msg.Succeed)
