...
{
    /// <summary>
    /// Srv_MCE_MCEAssetseDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetseDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择资产卡片.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS.Proxy.Delete_Ext(listID);
                if (!msg.Succeed)
