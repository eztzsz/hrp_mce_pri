...
{
    /// <summary>
    /// Srv_MCE_MCETypeDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCETypeDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_D_MCE_TYPE.Proxy.Delete_Ext(listID);
                if (!msg.Succeed)
