...
{
    /// <summary>
    /// Srv_MCE_GetMCEInstockList 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEInstockList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                DisplayObject_MCE_B_ASSETS_INSTOCK[] list = BizLogicObject_MCE_B_ASSETS_INSTOCK.Proxy.Query(p, pager, orderBy);
