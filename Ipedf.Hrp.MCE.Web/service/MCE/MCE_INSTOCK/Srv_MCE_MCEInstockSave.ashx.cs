...
{
    /// <summary>
    /// Srv_MCE_MCEInstockSave 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEInstockSave : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                JsonMCE_INSTOCK entity = JsonConvert.DeserializeObject<JsonMCE_INSTOCK>(rsb.ToString());
                ...
                {
                    foreach (JsonMCE_INSTOCK_D item in entity.children)
                    {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_INSTOCK.Proxy.Save_Ext(entity);
                if (!msg.Succeed)
