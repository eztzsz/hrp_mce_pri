...
{
    /// <summary>
    /// Srv_MCE_GetMCEMeterTypeDetail 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEMeterTypeDetail : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                DisplayObject_MCE_B_ASSETS_METER_TYPE[] listHead = BizLogicObject_MCE_B_ASSETS_METER_TYPE.Proxy.Query(p);
