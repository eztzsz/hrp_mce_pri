...
{
    /// <summary>
    /// Srv_MCE_MCEMeterTypeDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEMeterTypeDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_METER_TYPE.Proxy.Delete_Ext(listID);
                if (!msg.Succeed)
