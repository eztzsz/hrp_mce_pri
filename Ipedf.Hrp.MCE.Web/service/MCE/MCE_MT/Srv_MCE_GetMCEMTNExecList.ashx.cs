...
{
    /// <summary>
    /// Srv_MCE_GetMCEMTNExecList 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEMTNExecList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(request["beginspan"]))
                {
                    ...
                    p.CREATE_DATE.End = DateTime.Parse(request["beginspan"].ToString()).AddDays(1);
                    /*
                    p.CREATE_DATE = new DateSpan();
                ...
                */
                ...
                DisplayObject_MCE_B_ASSETS_MT_EXEC[] list = BizLogicObject_MCE_B_ASSETS_MT_EXEC.Proxy.Query(p, pager, orderBy);
