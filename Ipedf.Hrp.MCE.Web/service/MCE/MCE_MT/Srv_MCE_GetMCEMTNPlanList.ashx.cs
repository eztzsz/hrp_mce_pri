...
{
    /// <summary>
    /// Srv_MCE_GetMCEMTNPlanList 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEMTNPlanList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(request["planstate"]))
                {
                    p.PLAN_STATE = int.Parse(request["planstate"].ToString());
                }
                ...
                DisplayObject_MCE_B_ASSETS_MT_PLAN[] list = BizLogicObject_MCE_B_ASSETS_MT_PLAN.Proxy.Query(p, pager, orderBy);
