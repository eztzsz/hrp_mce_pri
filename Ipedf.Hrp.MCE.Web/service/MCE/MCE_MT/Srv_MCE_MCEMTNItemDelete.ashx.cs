...
{
    /// <summary>
    /// Srv_MCE_MCEMTNItemDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEMTNItemDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_MT_ITEM.Proxy.Delete_Ext(listID);
                if (!msg.Succeed)
