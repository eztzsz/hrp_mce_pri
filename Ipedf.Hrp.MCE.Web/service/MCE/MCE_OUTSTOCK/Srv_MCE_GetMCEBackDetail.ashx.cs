...
{
    /// <summary>
    /// Srv_MCE_GetMCEBackDetail 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEBackDetail : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                DisplayObject_MCE_B_ASSETS_BACK[] listHead = BizLogicObject_MCE_B_ASSETS_BACK.Proxy.Query(p);
                ...
                CauseObject_MCE_B_ASSETS_BACK_D pd = new CauseObject_MCE_B_ASSETS_BACK_D();
                pd.BASE_ID = request["id"].ToString();


                DisplayObject_MCE_B_ASSETS_BACK_D[] listDetail = BizLogicObject_MCE_B_ASSETS_BACK_D.Proxy.Query(pd, null, orderBy);
