...
{
    /// <summary>
    /// Srv_MCE_CancelPrvAudit 的摘要说明
    /// </summary>
    public class Srv_MCE_CancelPrvAudit : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                foreach (string strID in idList)
                {
                    ...
                    {
                        throw new Exception("供应商" + listExist[0].NAME + "已经审核,不能取消.");
                    }
                }



                BizLogicMsg msg = BizLogicObject_MCE_D_MCE_TYPE.Proxy.CancelPrvAudit(idList);
