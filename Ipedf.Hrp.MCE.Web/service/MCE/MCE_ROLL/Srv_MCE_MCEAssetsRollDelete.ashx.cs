...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsRollDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsRollDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("请选择要删除的案卷.");
                }

                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_ROLL.Proxy.Delete_Ext(strID);
                if (!msg.Succeed)
