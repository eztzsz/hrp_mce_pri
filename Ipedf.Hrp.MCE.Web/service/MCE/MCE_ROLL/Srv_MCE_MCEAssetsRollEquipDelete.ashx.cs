...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsRollEquipDelete 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsRollEquipDelete : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_ROLL.Proxy.Delete_RollEquip(strID);
                if (!msg.Succeed)
