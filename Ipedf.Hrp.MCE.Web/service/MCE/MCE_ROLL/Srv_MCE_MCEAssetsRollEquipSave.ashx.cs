...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsRollEquipSave 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsRollEquipSave : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                JsonMceAssetsRollEquip item = JsonConvert.DeserializeObject<JsonMceAssetsRollEquip>(rsb.ToString());
                ...
                {
                    throw new Exception("案卷ID不能为空.");
                }


                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_ROLL.Proxy.Save_RollEquip(item);
                if (!msg.Succeed)
