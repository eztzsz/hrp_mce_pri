...
{
    /// <summary>
    /// Srv_MCE_MCEAssetsRollFileSave 的摘要说明
    /// </summary>
    public class Srv_MCE_MCEAssetsRollFileSave : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                List<JsonMceAssetsRollFile> listItem = JsonConvert.DeserializeObject<List<JsonMceAssetsRollFile>>(rsb.ToString());

                if (listItem == null || listItem.Count==0)
                {
                    throw new Exception("参数错误,保存的文件数不能为空.");
                }
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_ASSETS_ROLL.Proxy.Save_RollFiles(listItem);
                if (!msg.Succeed)
