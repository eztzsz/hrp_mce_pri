...
{
    /// <summary>
    /// Srv_MCE_GetMCECheckList 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCECheckList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                DisplayObject_MCE_B_ASSETS_CHECK[] list = BizLogicObject_MCE_B_ASSETS_CHECK.Proxy.Query(p, pager, orderBy);
