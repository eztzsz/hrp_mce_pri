...
{
    /// <summary>
    /// Srv_MCE_GetMCESalesReturnList 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCESalesReturnList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    p.PROVIDER_ID = request["prv"].ToString();
                }
                ...
                DisplayObject_MCE_B_SALES_RETURN[] list = BizLogicObject_MCE_B_SALES_RETURN.Proxy.Query(p, pager, orderBy);
