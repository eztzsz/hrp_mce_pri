...
{
    /// <summary>
    /// Srv_MCE_MCESalesReturnSave 的摘要说明
    /// </summary>
    public class Srv_MCE_MCESalesReturnSave : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                JsonMCE_SALESRETURN entity = JsonConvert.DeserializeObject<JsonMCE_SALESRETURN>(rsb.ToString());
                ...
                {
                    throw new Exception("参数错误,退货人不能为空.");
                }
                ...
                {
                    foreach (JsonMCE_SALESRETURN_D item in entity.children)
                    {
                ...
                BizLogicMsg msg = BizLogicObject_MCE_B_SALES_RETURN.Proxy.Save_Ext(entity);
                if (!msg.Succeed)
