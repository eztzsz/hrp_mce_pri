...
{
    /// <summary>
    /// Srv_MCE_GetMCEWriteOffList 的摘要说明
    /// </summary>
    public class Srv_MCE_GetMCEWriteOffList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(request["write_off_type_id"]))
                {
                    p.WRITE_OFF_TYPE_ID= request["write_off_type_id"].ToString();
                }
                ...
                DisplayObject_MCE_B_ASSETS_WRITE_OFF[] list = BizLogicObject_MCE_B_ASSETS_WRITE_OFF.Proxy.Query(p, pager, orderBy);
